...
{n : _} -> TTC (PrimFn n) where
  ...
  toBuf b FloatSqrt = tag 28
  toBuf b FloatFloor = tag 29
  toBuf b FloatCeiling = tag 30

  toBuf b DoubleExp = tag 40
  toBuf b DoubleLog = tag 41
  toBuf b DoublePow = tag 42
  toBuf b DoubleSin = tag 43
  toBuf b DoubleCos = tag 44
  toBuf b DoubleTan = tag 45
  toBuf b DoubleASin = tag 46
  toBuf b DoubleACos = tag 47
  toBuf b DoubleATan = tag 48
  toBuf b DoubleSqrt = tag 49
  toBuf b DoubleFloor = tag 50
  toBuf b DoubleCeiling = tag 51
