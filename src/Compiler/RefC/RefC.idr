...
cOp FloatExp      [x]       = "(Value*)makeFloat(exp(unpackFloat(" ++ x ++ ")))"
cOp FloatLog      [x]       = "(Value*)makeFloat(log(unpackFloat(" ++ x ++ ")))"
cOp FloatSin      [x]       = "(Value*)makeFloat(sin(unpackFloat(" ++ x ++ ")))"
cOp FloatCos      [x]       = "(Value*)makeFloat(cos(unpackFloat(" ++ x ++ ")))"
cOp FloatTan      [x]       = "(Value*)makeFloat(tan(unpackFloat(" ++ x ++ ")))"
cOp FloatASin     [x]       = "(Value*)makeFloat(asin(unpackFloat(" ++ x ++ ")))"
cOp FloatACos     [x]       = "(Value*)makeFloat(acos(unpackFloat(" ++ x ++ ")))"
cOp FloatATan     [x]       = "(Value*)makeFloat(atan(unpackFloat(" ++ x ++ ")))"
cOp FloatSqrt     [x]       = "(Value*)makeFloat(sqrt(unpackFloat(" ++ x ++ ")))"
cOp FloatFloor    [x]       = "(Value*)makeFloat(floor(unpackFloat(" ++ x ++ ")))"
cOp FloatCeiling  [x]       = "(Value*)makeFloat(ceil(unpackFloat(" ++ x ++ ")))"
