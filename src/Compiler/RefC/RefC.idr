...
cOp FloatExp      [x]       = "(Value*)makeFloat(fexp(unpackFloat(" ++ x ++ ")))"
cOp FloatLog      [x]       = "(Value*)makeFloat(flog(unpackFloat(" ++ x ++ ")))"
cOp FloatPow      [x, y]    = "(Value*)makeFloat(fpow(unpackFloat(" ++ x ++ "), unpackFloat(" ++ y ++ ")))"
cOp FloatSin      [x]       = "(Value*)makeFloat(fsin(unpackFloat(" ++ x ++ ")))"
cOp FloatCos      [x]       = "(Value*)makeFloat(fcos(unpackFloat(" ++ x ++ ")))"
cOp FloatTan      [x]       = "(Value*)makeFloat(ftan(unpackFloat(" ++ x ++ ")))"
cOp FloatASin     [x]       = "(Value*)makeFloat(fasin(unpackFloat(" ++ x ++ ")))"
cOp FloatACos     [x]       = "(Value*)makeFloat(facos(unpackFloat(" ++ x ++ ")))"
cOp FloatATan     [x]       = "(Value*)makeFloat(fatan(unpackFloat(" ++ x ++ ")))"
cOp FloatSqrt     [x]       = "(Value*)makeFloat(fsqrt(unpackFloat(" ++ x ++ ")))"
cOp FloatFloor    [x]       = "(Value*)makeFloat(ffloor(unpackFloat(" ++ x ++ ")))"
cOp FloatCeiling  [x]       = "(Value*)makeFloat(fceil(unpackFloat(" ++ x ++ ")))"
