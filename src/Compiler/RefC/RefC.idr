...
cPrimType Float32Type = "float"
cPrimType Float64Type = "double"
...
cOp Float32Exp     [x]       = "(Value*)makeFloat(exp(unpackFloat(" ++ x ++ ")))"
cOp Float32Log     [x]       = "(Value*)makeFloat(log(unpackFloat(" ++ x ++ ")))"
cOp Float32Pow     [x, y]    = "(Value*)makeFloat(pow(unpackFloat(" ++ x ++ "), unpackFloat(" ++ y ++ ")))"
cOp Float32Sin     [x]       = "(Value*)makeFloat(sin(unpackFloat(" ++ x ++ ")))"
cOp Float32Cos     [x]       = "(Value*)makeFloat(cos(unpackFloat(" ++ x ++ ")))"
cOp Float32Tan     [x]       = "(Value*)makeFloat(tan(unpackFloat(" ++ x ++ ")))"
cOp Float32ASin    [x]       = "(Value*)makeFloat(asin(unpackFloat(" ++ x ++ ")))"
cOp Float32ACos    [x]       = "(Value*)makeFloat(acos(unpackFloat(" ++ x ++ ")))"
cOp Float32ATan    [x]       = "(Value*)makeFloat(atan(unpackFloat(" ++ x ++ ")))"
cOp Float32Sqrt    [x]       = "(Value*)makeFloat(sqrt(unpackFloat(" ++ x ++ ")))"
cOp Float32Floor   [x]       = "(Value*)makeFloat(floor(unpackFloat(" ++ x ++ ")))"
cOp Float32Ceiling [x]       = "(Value*)makeFloat(ceil(unpackFloat(" ++ x ++ ")))"

cOp Float64Exp     [x]       = "(Value*)makeDouble(exp(unpackDouble(" ++ x ++ ")))"
cOp Float64Log     [x]       = "(Value*)makeDouble(log(unpackDouble(" ++ x ++ ")))"
cOp Float64Pow     [x, y]    = "(Value*)makeDouble(pow(unpackDouble(" ++ x ++ "), unpackDouble(" ++ y ++ ")))"
cOp Float64Sin     [x]       = "(Value*)makeDouble(sin(unpackDouble(" ++ x ++ ")))"
cOp Float64Cos     [x]       = "(Value*)makeDouble(cos(unpackDouble(" ++ x ++ ")))"
cOp Float64Tan     [x]       = "(Value*)makeDouble(tan(unpackDouble(" ++ x ++ ")))"
cOp Float64ASin    [x]       = "(Value*)makeDouble(asin(unpackDouble(" ++ x ++ ")))"
cOp Float64ACos    [x]       = "(Value*)makeDouble(acos(unpackDouble(" ++ x ++ ")))"
cOp Float64ATan    [x]       = "(Value*)makeDouble(atan(unpackDouble(" ++ x ++ ")))"
cOp Float64Sqrt    [x]       = "(Value*)makeDouble(sqrt(unpackDouble(" ++ x ++ ")))"
cOp Float64Floor   [x]       = "(Value*)makeDouble(floor(unpackDouble(" ++ x ++ ")))"
cOp Float64Ceiling [x]       = "(Value*)makeDouble(ceil(unpackDouble(" ++ x ++ ")))"
...
cTypeOfCFType CFFloat32       = "float"
cTypeOfCFType CFFloat64       = "double"
...
extractValue _ CFFloat32        varName = "((Value_Float*)" ++ varName ++ ")->f"
extractValue _ CFFloat64        varName = "((Value_Double*)" ++ varName ++ ")->d"
...
packCFType CFFloat32       varName = "makeFloat(" ++ varName ++ ")"
packCFType CFFloat64       varName = "makeDouble(" ++ varName ++ ")"
