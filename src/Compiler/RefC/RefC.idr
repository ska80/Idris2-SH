...
cOp FloatExp      [x]       = "(Value*)makeFloat(expf(unpackFloat(" ++ x ++ ")))"
cOp FloatLog      [x]       = "(Value*)makeFloat(logf(unpackFloat(" ++ x ++ ")))"
cOp FloatPow      [x, y]    = "(Value*)makeFloat(powf(unpackFloat(" ++ x ++ "), unpackFloat(" ++ y ++ ")))"
cOp FloatSin      [x]       = "(Value*)makeFloat(sinf(unpackFloat(" ++ x ++ ")))"
cOp FloatCos      [x]       = "(Value*)makeFloat(cosf(unpackFloat(" ++ x ++ ")))"
cOp FloatTan      [x]       = "(Value*)makeFloat(tanf(unpackFloat(" ++ x ++ ")))"
cOp FloatASin     [x]       = "(Value*)makeFloat(asinf(unpackFloat(" ++ x ++ ")))"
cOp FloatACos     [x]       = "(Value*)makeFloat(acosf(unpackFloat(" ++ x ++ ")))"
cOp FloatATan     [x]       = "(Value*)makeFloat(atanf(unpackFloat(" ++ x ++ ")))"
cOp FloatSqrt     [x]       = "(Value*)makeFloat(sqrtf(unpackFloat(" ++ x ++ ")))"
cOp FloatFloor    [x]       = "(Value*)makeFloat(floorf(unpackFloat(" ++ x ++ ")))"
cOp FloatCeiling  [x]       = "(Value*)makeFloat(ceilf(unpackFloat(" ++ x ++ ")))"
...
extractValue _ CFFloat          varName = "((Value_Float*)" ++ varName ++ ")->f"
...
packCFType CFFloat         varName = "makeFloat(" ++ varName ++ ")"
