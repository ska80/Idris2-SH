...
Value *cast_Int8_to_float(Value *);
...
Value *cast_Int16_to_float(Value *);
...
Value *cast_Int32_to_float(Value *);
...
Value *cast_Int64_to_float(Value *);
Value *cast_Int64_to_double(Value *);
Value *cast_Int64_to_char(Value *);
Value *cast_Int64_to_string(Value *);

Value *cast_float_to_Bits8(Value *);
Value *cast_float_to_Bits16(Value *);
Value *cast_float_to_Bits32(Value *);
Value *cast_float_to_Bits64(Value *);
Value *cast_float_to_Int8(Value *);
Value *cast_float_to_Int16(Value *);
Value *cast_float_to_Int32(Value *);
Value *cast_float_to_Int64(Value *);
...
Value *cast_char_to_float(Value *);
...
Value *cast_string_to_float(Value *);
